    ...
    <div class="container">
        ...
        @else
            ...
            <form class="max-w-sm" action="{{ route('place.order') }}" method="post">
                ...
                {{-- /* The code snippet you provided is creating an input field for the game ID within a form. Let's break
            down the elements and their purposes: */ --}}
                <div class="mb-2">
                    <label for="game_id" class="block mb-2 text-sm font-medium text-light-theme">ID Game</label>
                    <input @if ($product->first()->category->id !== 3) type="number" @else type="text" @endif id="game_id"
                        name="game_id"
                ...
                {{-- /* The code snippet you provided is creating an input field for the server number within a form. Let's
            break down the elements and their purposes: */ --}}
                <div class="mb-2">
                    <label for="server_num" class="block mb-2 text-sm font-medium text-light-theme">
                        @if ($product->first()->category->id !== 3)
                            Server Number
                        @else
                            Tags
                        @endif
                    </label>
                    <input type="number" id="server_num" name="server_num"
                        class="bg-gray-50 border border-gray-300 text-dark-theme text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        @if ($product->first()->category->id !== 3) placeholder="Server Number"
                        @else
                        placeholder="Tags" @endif
                        required />
                </div>
            ...
            Let's break down the HTML elements and their purposes: */ --}}
                <div class="mb-2">
                    ...
                    <input type="email" id="email" name="email"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-dark-theme text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
